...
public:
  ...
  void dump() {
    ...
    std::cout << "Total spawn_root_and_wait() time: " << spawn_root_and_wait_time / 1000000
              << " milliseconds"
              << "\n";
    std::cout << "Base tbb::spawn_root_and_wait() time: " << tbb_spawn_root_and_wait_time / 1000000
              << " milliseconds"
              << "\n";
    std::cout << "Total number of spawn_root_and_wait() calls: " << num_spawn_root_and_wait
              << "\n\n";

    std::cout << "Total spawn_and_wait_for_all() time: " << spawn_and_wait_for_all_time / 1000000
              << " milliseconds"
              << "\n";
    std::cout << "Base tbb::spawn_and_wait_for_all() time: "
              << tbb_spawn_and_wait_for_all_time / 1000000 << " milliseconds"
              << "\n";
    ...
    std::cout << "Total wait_for_all() time: " << wait_for_all_time / 1000000 << " milliseconds"
              << "\n";
    std::cout << "Base tbb::wait_for_all() time: " << tbb_wait_for_all_time / 1000000
              << " milliseconds"
              << "\n";
