...
#include "llvm/Transforms/PTaskDebug/PTaskDebugPass.h"

// void getAnalysisUsage(AnalysisUsage &Info) {
//  Info.addRequired<AliasAnalysis>();
//}

bool PTaskDebug::hasAnnotation(Instruction *i, Value *V, StringRef Ann,
                               uint8_t level) {
...
PTaskDebug::PTaskDebug() : ModulePass(ID) { num_accesses = 0; }

void PTaskDebug::instrument_access(Value *op, Instruction *inst, Constant *rdWr,
                                   Module &module) {
...
void PTaskDebug::parseBB(BasicBlock &blk, Module &module) {
...
void PTaskDebug::intializeTaskDebugVariables(Module &module) {
...
void PTaskDebug::intializeTaskDebugFunctions(Module &module) {
...
bool PTaskDebug::instru_fn(StringRef fn_name) {
...
bool PTaskDebug::runOnModule(Module &module) {
  // errs() << "TaskDebugPass:\n";
...
char PTaskDebug::ID = 0;
static RegisterPass<PTaskDebug> X("ptask_debug", "Ptracer TaskDebug Pass");
