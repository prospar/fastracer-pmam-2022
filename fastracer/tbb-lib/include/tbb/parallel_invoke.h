...
namespace internal {
	...
	bool is_recycled;
	  ...
	  internal::function_invoker<function1>* invoker1 = new (allocate_child()) internal::function_invoker<function1>(my_func1);
    ...
    public:
        ...
        void run_and_finish(const F0& f0)
        {
            ...
            __TBB_ASSERT(invoker, "Child task allocation failed");
            t_debug_task::spawn_and_wait_for_all(*invoker);
        }
    };
