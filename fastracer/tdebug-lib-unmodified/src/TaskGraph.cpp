...
void TaskGraph::print() { printGraph(head); }
...
void TaskGraph::StepCheck(THREADID threadid) { return; }

void TaskGraph::CaptureWaitOnly(THREADID threadid) { return; }

void TaskGraph::Pause(THREADID threadid) { return; }

void TaskGraph::CaptureSetTaskId(THREADID threadid, size_t taskId, int sp_only) { return; }
