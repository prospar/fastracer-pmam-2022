...
;;                                            (async-shell-command
;;                                             (format "rsync -avz -e 'ssh' --exclude=.git
;; --exclude=obj --exclude=.clangd ../newfasttrack/ swarnendu@swarnendu6.cse.iitk.ac.in:/home/swarnendu/prospar-workspace/ptracer-prospar-swarnendu/newfasttrack/."))))
         ))
 (c++-mode . (
              ...
              (lsp-clients-clangd-args . ("--compile-commands-dir=newfasttrack"
                                          "--clang-tidy"
                                          "--pch-storage=memory"
                                          "--background-index"
                                          "--pretty"
