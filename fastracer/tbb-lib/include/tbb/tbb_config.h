...
// PROSPAR: SB: Changed the following declarations to allow compilation with GCC 7

// #define __TBB_CPP11_TYPE_PROPERTIES_PRESENT (_LIBCPP_VERSION || _MSC_VER >= 1700)
// #define __TBB_TR1_TYPE_PROPERTIES_IN_STD_PRESENT                                                   \
//   (__GXX_EXPERIMENTAL_CXX0X__ && __TBB_GCC_VERSION >= 40300 || _MSC_VER >= 1600)
// // GCC has a partial support of type properties
// #define __TBB_CPP11_IS_COPY_CONSTRUCTIBLE_PRESENT                                                  \
//   (__GXX_EXPERIMENTAL_CXX0X__ && __TBB_GCC_VERSION >= 40700 || __TBB_CPP11_TYPE_PROPERTIES_PRESENT)
...
#define __TBB_TR1_TYPE_PROPERTIES_IN_STD_PRESENT                                                   \
  (__GXX_EXPERIMENTAL_CXX0X__ && __TBB_GLIBCXX_VERSION >= 40300 || _MSC_VER >= 1600)
// GCC has a partial support of type properties
#define __TBB_CPP11_IS_COPY_CONSTRUCTIBLE_PRESENT                                                  \
