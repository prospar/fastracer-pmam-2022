...
#include "llvm/Transforms/Prospar/InstrMemAccesses.h" // PROSPAR: Added
...
static void addPTaskDebugPass(const PassManagerBuilder &Builder,
                              PassManagerBase &PM) {
  // const PassManagerBuilderWrapper &BuilderWrapper =
  // static_cast<const PassManagerBuilderWrapper&>(Builder);
  // const CodeGenOptions &CGOpts = BuilderWrapper.getCGOpts();
  PM.add(new PTaskDebug());
  PM.add(new PTaskDebugBranchCheck());
}

static void addProsparPass(const PassManagerBuilder &Builder,
                           PassManagerBase &PM) {
  PM.add(new ProsparMemAccesses());
}
